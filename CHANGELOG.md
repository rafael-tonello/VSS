...
- build: adjust new version system and git hooks
- chore: adjusts CHANGELOG.md
- doc: add pman.sh and dev instructions to the README.md
- chore: adjusts .gitignore
- chore: add missing prfixtree files
- chore: fixes git
